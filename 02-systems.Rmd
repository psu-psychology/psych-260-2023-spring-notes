...
```{r systems-cartoon, fig.cap="https://s3.amazonaws.com/lowres.cartoonstock.com/fashion-smart_casual-dress_code-dress_code-protest-fashion_statement-sbln385_low.jpg"}
...
```{r network-sci-fig, fig.cap="[[@Cole2013-zj]](http://dx.doi.org/10.1038/nn.3470)"}
