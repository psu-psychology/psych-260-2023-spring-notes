...
```{r, fig.cap="Law & Order: Special Victims Unit", out.width="40%"}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/SVU_Logo.webp/250px-SVU_Logo.webp.png")
```

**C**entral **O**ligodendrocytes  **S**chwann cells
